#!/usr/bin/env python3
"""
Dutch Passion Comprehensive Scraper
Using 4-method extraction approach from COMPREHENSIVE_SCRAPING_STRATEGY.md
Target: 500+ strains from feminised, regular, and autoflowering collections
"""
...
class DutchPassionStrainScraper:
    def __init__(self):
        self.base_url = "https://dutch-passion.com"
        self.collection_urls = [
            "https://dutch-passion.com/en/feminised-seeds",
            "https://dutch-passion.com/en/regular-seeds",
            "https://dutch-passion.com/en/autoflowering-seeds"
        ]
    ...
    def _extract_basic_info(self, soup, strain_data, url):
        ...
        for selector in title_selectors:
            ...
            if element:
                ...
                # Clean up title
                strain_name = re.sub(r'\s*-\s*Dutch Passion.*', '', title, flags=re.IGNORECASE)
        ...
        if not strain_data.get('strain_name'):
            ...
            if len(url_parts) > 0:
                ...
                strain_name = re.sub(r'\s*Dutch Passion.*', '', strain_name, flags=re.IGNORECASE)
                strain_data['strain_name'] = strain_name.strip()
        ...
        if not strain_data.get('breeder_name'):
            strain_data['breeder_name'] = "Dutch Passion"
    ...
    def save_to_dynamodb(self, strain_data):
        ...
        try:
            ...
            # Add metadata
            strain_data['source'] = 'dutch_passion'
    ...
    def scrape_all_strains(self):
        ...
        print("Starting Dutch Passion comprehensive scraping...")
...
if __name__ == "__main__":
    scraper = DutchPassionStrainScraper()
