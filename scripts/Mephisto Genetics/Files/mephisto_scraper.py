#!/usr/bin/env python3
"""
Mephisto Genetics Comprehensive Scraper
Using 4-method extraction approach from COMPREHENSIVE_SCRAPING_STRATEGY.md
Target: Premium autoflower strains from the legendary Mephisto collection
"""
...
class MephistoStrainScraper:
    def __init__(self):
        self.base_url = "https://mephistogenetics.com"
        self.collection_urls = [
            "https://mephistogenetics.com/collections/seeds"
        ]
    ...
    def _extract_basic_info(self, soup, strain_data, url):
        ...
        for selector in title_selectors:
            ...
            if element:
                ...
                # Clean up title
                strain_name = re.sub(r'\s*-\s*Mephisto Genetics.*', '', title, flags=re.IGNORECASE)
        ...
        if not strain_data.get('strain_name'):
            ...
            if len(url_parts) > 0:
                ...
                strain_name = re.sub(r'\s*Mephisto.*', '', strain_name, flags=re.IGNORECASE)
                strain_data['strain_name'] = strain_name.strip()
    ...
    def save_to_dynamodb(self, strain_data):
        ...
        try:
            ...
            # Add metadata
            strain_data['source'] = 'mephisto_genetics'
    ...
    def scrape_all_strains(self):
        ...
        print("Starting Mephisto Genetics comprehensive scraping...")
        ...
        print(f"\nMEPHISTO GENETICS SCRAPING COMPLETE!")
